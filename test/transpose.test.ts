import { NashvilleNotation, ChoproFile, ChoproBlock, ChordSegment } from "../src/parser";

import { AbstractNote, Accidental, MusicNote, KeyInfo, AbsoluteKeyInfo } from "../src/music";
...
describe("TransposeUtils", () => {
    ...
    describe("isValidKey", () => {
        ...
        test.each(validKeyTestCases)("should validate $key as valid ($description)", ({ key }) => {
